 ...
 * now the document language is fixed to English. The layout stays minimal
 * so individual route segments can compose their own chrome on top of the
 * client-side `Providers` (theme + toasts).
 *
 * `suppressHydrationWarning` is required by next-themes so the server-
 * rendered (themeless) HTML can be reconciled against the client-side
 * theme class without a hydration mismatch.
 */
